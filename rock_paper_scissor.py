...
root.configure(background="#5E65EE")

# Get the directory of the current script file
script_dir = os.path.dirname(os.path.abspath(__file__))

rock_img = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "rock-user.png")))
paper_img = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "paper-user.png")))
scissor_img = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "scissors-user.png")))
rock_img_comp = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "rock.png")))
paper_img_comp = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "paper.png")))
scissor_img_comp = ImageTk.PhotoImage(Image.open(os.path.join(script_dir, "scissors.png")))
...
reset_button.grid(row=5, column=4, pady=20)
